...
export function useUpsertCompanySettings() {
  ...
  return useMutation({
    mutationFn: async (settings: Partial<CompanySettings>) => {
      ...
      const { data, error } = await supabase
        .from('company_settings')
        .upsert({ ...settings, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
...
export function useCreatePart() {
  ...
  return useMutation({
    mutationFn: async (part: Partial<Part>) => {
      ...
      const { data, error } = await supabase
        .from('parts_catalog')
        .insert({ ...part, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
...
export function useCreateEngine() {
  ...
  return useMutation({
    mutationFn: async (engine: Partial<Engine>) => {
      ...
      const { data, error } = await supabase
        .from('engines')
        .insert({ ...engine, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
...
export function useCreateFleetUnit() {
  ...
  return useMutation({
    mutationFn: async (unit: Partial<FleetUnit>) => {
      ...
      const { data, error } = await supabase
        .from('fleet_units')
        .insert({ ...unit, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
...
export function useUpsertEngineServiceSpec() {
  ...
  return useMutation({
    mutationFn: async (spec: Partial<EngineServiceSpec>) => {
      ...
      const { data, error } = await supabase
        .from('engine_service_specs')
        .upsert({ ...spec, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ['engine_service_specs'] }),
  });
}

// =============================================
// UNIT SERVICE OVERRIDES
// =============================================
...
export function useUpsertUnitServiceOverride() {
  ...
  return useMutation({
    mutationFn: async (override: Partial<UnitServiceOverride>) => {
      ...
      const { data, error } = await supabase
        .from('unit_service_overrides')
        .upsert({ ...override, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ['unit_service_overrides'] }),
  });
}
...
export function useCreateWorkOrder() {
  ...
  return useMutation({
    mutationFn: async (wo: Partial<WorkOrder>) => {
      ...
      const { data, error } = await supabase
        .from('work_orders')
        .insert({ ...wo, user_id: userData.user.id })
        .select()
        .single();
      if (error) throw error;
      return data;
