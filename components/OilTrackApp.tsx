...
/* ===== PRINT STYLES (improved multi-page) ===== */
@page{size:letter;margin:0.5in 0.5in 0.5in 0.5in}
@media print{
  /* hide everything that's not the work order */
  .sb,.topbar,.crumbs,.btn,.ab,.ck,.tklist-item,.psearchres,.tplist-item .qty input{display:none!important}
  body,html{background:#fff!important;color:#000!important;font-size:10pt}
  ...
  .wo{border:none!important;border-radius:0!important}
  /* show printable header */
  .print-only{display:block!important}
  .print-header{padding:0 0 12pt 0;border-bottom:2pt solid #000;margin-bottom:12pt;display:flex;justify-content:space-between;align-items:flex-start;page-break-after:avoid}
  .print-header .co h1{font-size:16pt;font-weight:800;color:#000;letter-spacing:-0.02em}
  .print-header .co p{font-size:8.5pt;color:#444;margin:1pt 0;white-space:pre-wrap}
  .print-header .inv{text-align:right}
  .print-header .inv .lbl{font-size:8pt;color:#666;text-transform:uppercase;letter-spacing:0.06em}
  .print-header .inv .num{font-size:14pt;font-weight:800;font-family:'IBM Plex Mono',monospace}
  .print-header .inv .date{font-size:9pt;color:#444}
  .print-billto{margin:8pt 0 12pt 0;display:grid;grid-template-columns:1fr 1fr;gap:20pt}
  .print-billto .lbl{font-size:8pt;color:#666;text-transform:uppercase;letter-spacing:0.06em;font-weight:700;margin-bottom:2pt}
  .print-billto p{font-size:9.5pt;line-height:1.35}
  /* page break BEFORE cost breakdown */
  .ws.cost-section{page-break-before:always}
  /* keep section internal contents together if they fit */
  .ws{page-break-inside:auto}
  .ws h4{page-break-after:avoid}
  table{page-break-inside:auto}
  tr{page-break-inside:avoid;page-break-after:auto}
  thead{display:table-header-group}
  /* tighten print spacing */
  .ws{padding:8pt 0!important;border-bottom:1pt solid #aaa!important}
  .wh{padding:0 0 8pt 0!important;border-bottom:1pt solid #aaa!important}
  .wi{gap:6pt!important}
  .cr{font-size:10pt;padding:2pt 0}
  .cr.tot{font-size:12pt;border-top:2pt solid #000;padding-top:4pt;margin-top:4pt}
  .tag{background:transparent!important;color:#000!important;border:1pt solid #888;padding:1pt 4pt}
  .runtpl,.tpcard{display:none!important}
  /* footer at bottom of every page */
  .print-footer{position:fixed;bottom:0;left:0;right:0;text-align:center;font-size:8pt;color:#888;padding-top:4pt;border-top:1pt solid #ccc}
}
`;
